import { Flame, Zap, BarChart3, Scale, FileText, Trash2, ClipboardList } from "lucide-react";
    ...
    <div className="rounded-[12px] bg-card border border-border p-5 shadow-md flex flex-col">
      ...
      <div className="grid grid-cols-2 gap-2 mb-3">
        <button
          ...
          className="flex items-center justify-center gap-1.5 px-3 py-2 rounded-[12px] border border-border text-xs font-medium text-muted-foreground hover:bg-accent transition-colors"
        >
